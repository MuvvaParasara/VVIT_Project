...
print(g.latlng)  # Returns latitude and longitude
print(g.city)
...
def user_home_page():
    ...
    if select == 'User Profile':
        ...
        st.write(data['Region'].unique().tolist())
        ...
        if user_input:
            # Check if the input is related to the liver
            ...
            if check_response == "yes":
                ...
                bot_prompt = f"Answer the following question in detail if it is about the liver: {user_input}"
                ...
                error_message = "Please ask a relevant question about the liver."
